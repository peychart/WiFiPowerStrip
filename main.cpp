...
void writeConfig(){        //Save current config:
  ...
  if(f){
    ...
    for(short i(0); i<outputCount(); i++){   //Save output states
...
inline void handleValueSubmit(short i){      //Set outputs values:
...
void loop(){
  ...
  for(short i(0); i<outputCount(); i++)                      //Tiners control:
