...
static String  outputName[outputCount()] = {"Yellow", "Green", "Orange", "Red", "Blue", "purple", "white"}; //can be change by interface...
static uint8_t _outputPin[outputCount()] = {   D0,       D1,      D2,      D3,    D4,      D8,      D9  };
