...
static String _outputName[maxPinsCount()]   ={"switch1", "switch2", "switch3", "switch4", "switch5"}; //can be change by interface...
static uint8_t _outputPin[outputPinsCount()]={   D1,         D2,        D3,        D4,        D0   };
